...
class Theme_Customizer {
	...
	public function add_woocommerce_choices() {
		if ( class_exists( 'woocommerce' ) ) {
			...
			$options['cart'] = array(
				'name'    => esc_html__( 'Cart', 'basetheme' ),
	...
	public function override_defaults( $wp_customize ) {
		...
		if ( ! empty( $opt_name_key = apply_filters( 'thebase_settings_key_custom_mapping', '', 'custom_logo' ) ) ) {
			...
			$control_config = array(
				...
				'capability'      => self::get_capability(),
				'priority'        => 4,
				'label'        => esc_html__( 'Logo', 'basetheme' ),
				'mime_type'    => 'image',
	...
	public static function get_panels() {
		...
		if ( is_null( self::$panels ) ) {
			$panels = array(
				'general' => array(
					'title'    => __( 'General', 'basetheme' ),
					'priority' => 18,
				),
				'header' => array(
					'title'    => __( 'Header', 'basetheme' ),
					'priority' => 20,
				),
				'footer' => array(
					'title'    => __( 'Footer', 'basetheme' ),
					'priority' => 22,
				),
				'blog_posts' => array(
					'title'    => __( 'Blog Posts', 'basetheme' ),
					'priority' => 23,
				),
				'custom_post' => array(
					'title'    => __( 'Custom Post Types', 'basetheme' ),
					'priority' => 24,
				),
			);
			if ( class_exists( 'SFWD_LMS' ) ) {
				$extra_learn['learndash'] = array(
					'title'    => __( 'LearnDash', 'basetheme' ),
					'priority' => 25,
				);
				$panels = array_merge(
					$panels,
	...
	public static function get_sections() {
		...
		if ( is_null( self::$sections ) ) {
			$sections = array(
				'site_identity' => array(
					'title'    => __( 'Site Identity', 'basetheme' ),
					'priority' => 25,
				),
				'general_layout' => array(
					'title'    => __( 'Layout', 'basetheme' ),
					'panel'    => 'general',
					'priority' => 7,
				),
				'sidebar' => array(
					'title'    => __( 'Sidebar', 'basetheme' ),
					'panel'    => 'general',
					'priority' => 8,
				),
				'sidebar_design' => array(
					'title'    => __( 'Sidebar Design', 'basetheme' ),
					'panel'    => 'general',
					'priority' => 8,
				),
				'general_colors' => array(
					'title'    => __( 'Colors', 'basetheme' ),
					'panel'    => 'general',
					'priority' => 9,
				),
				'general_buttons' => array(
					'title'    => __( 'Buttons', 'basetheme' ),
					'panel'    => 'general',
					'priority' => 10,
				),
				...
				'scroll_up' => array(
					'title'    => __( 'Scroll To Top', 'basetheme' ),
					'panel'    => 'general',
					'priority' => 12,
				),
				...
				'general_social' => array(
					'title'    => __( 'Social Links', 'basetheme' ),
					'panel'    => 'general',
					'priority' => 20,
				),
				'general_comments' => array(
					'title'    => __( 'Comments', 'basetheme' ),
					'panel'    => 'general',
					'priority' => 20,
				),
				'general_performance' => array(
					'title'    => __( 'Performance', 'basetheme' ),
					'panel'    => 'general',
					'priority' => 21,
				),
				'breadcrumbs' => array(
					'title'    => __( 'Breadcrumbs', 'basetheme' ),
					'panel'    => 'general',
					'priority' => 20,
				),
				'general_404' => array(
					'title'    => __( '404 Page Layout', 'basetheme' ),
					'panel'    => 'general',
					'priority' => 20,
				),
				...
				'header_builder' => array(
					'title'    => __( 'Header Builder', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 9,
				),
				'header_top' => array(
					'title'    => __( 'Top Row', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 10,
				),
				'header_main' => array(
					'title'    => __( 'Main Row', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 10,
				),
				'header_bottom' => array(
					'title'    => __( 'Bottom Row', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 10,
				),
				'header_popup' => array(
					'title'    => __( 'Header Off Canvas', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 10,
				),
				...
				'primary_navigation' => array(
					'title'    => __( 'Primary Navigation', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				'secondary_navigation' => array(
					'title'    => __( 'Secondary Navigation', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				'dropdown_navigation' => array(
					'title'    => __( 'Dropdown Navigation', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'mobile_trigger' => array(
					'title'    => __( 'Mobile Trigger', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'mobile_navigation' => array(
					'title'    => __( 'Mobile Navigation', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				'mobile_button' => array(
					'title'    => __( 'Header Mobile Button', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'mobile_html' => array(
					'title'    => __( 'Header Mobile HTML', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				'header_html' => array(
					'title'    => __( 'HTML Editor', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'cart' => array(
					'title'    => __( 'Header Cart', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				'cart_design' => array(
					'title'    => __( 'Header Cart Design', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				'mobile_cart' => array(
					'title'    => __( 'Mobile Header Cart', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'header_button' => array(
					'title'    => __( 'Header Button', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'header_social' => array(
					'title'    => __( 'Header Social', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'header_search' => array(
					'title'    => __( 'Header Search', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				'transparent_header' => array(
					'title'    => __( 'Transparent Header', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'header_sticky' => array(
					'title'    => __( 'Sticky Header', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 20,
				),
				...
				'footer_builder' => array(
					'title'    => __( 'Footer Builder', 'basetheme' ),
					'panel'    => 'footer',
					'priority' => 9,
				),
				'footer_top' => array(
					'title'    => __( 'Footer Top', 'basetheme' ),
					'panel'    => 'footer',
					'priority' => 10,
				),
				...
				'footer_middle' => array(
					'title'    => __( 'Footer Middle', 'basetheme' ),
					'panel'    => 'footer',
					'priority' => 10,
				),
				...
				'footer_bottom' => array(
					'title'    => __( 'Footer Bottom', 'basetheme' ),
					'panel'    => 'footer',
					'priority' => 10,
				),
				...
				'footer_html' => array(
					'title'    => __( 'Footer Copyright HTML', 'basetheme' ),
					'panel'    => 'footer',
					'priority' => 10,
				),
				'footer_social' => array(
					'title'    => __( 'Footer Social', 'basetheme' ),
					'panel'    => 'footer',
					'priority' => 10,
				),
				...
				'footer_navigation' => array(
					'title'    => __( 'Footer Navigation', 'basetheme' ),
					'panel'    => 'footer',
					'priority' => 10,
				),
				'page_layout' => array(
				...
				'search' => array(
					'title'    => __( 'Search Results', 'basetheme' ),
					'priority' => 24,
				),
				'search_design' => array(
					'title'    => __( 'Search Results', 'basetheme' ),
				...
				'post_layout' => array(
					'title'    => __( 'Single Post Layout', 'basetheme' ),
					'panel'    => 'blog_posts',
					'priority' => 24,
				),
				...
				'post_archive' => array(
					'title'    => __( 'Archive Layout', 'basetheme' ),
					'panel'    => 'blog_posts',
					'priority' => 25,
				),
			...
			if ( ( defined( 'GUTENBERG_VERSION' ) && version_compare( GUTENBERG_VERSION, '10.6.2', '>' ) ) || version_compare( substr( get_bloginfo( 'version' ), 0, 3 ), '5.8', '>=' ) ) {
				$blocks_extra['sidebar-widgets-footer1'] = array(
					'title'    => __( 'Widget Footer 1 Settings', 'basetheme' ),
					'panel'    => 'footer',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-footer2'] = array(
					'title'    => __( 'Widget Footer 2 Settings', 'basetheme' ),
					'panel'    => 'footer',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-footer3'] = array(
					'title'    => __( 'Widget Footer 3 Settings', 'basetheme' ),
					'panel'    => 'footer',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-footer4'] = array(
					'title'    => __( 'Widget Footer 4 Settings', 'basetheme' ),
					'panel'    => 'footer',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-footer5'] = array(
					'title'    => __( 'Widget Footer 5 Settings', 'basetheme' ),
					'panel'    => 'footer',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-footer6'] = array(
					'title'    => __( 'Widget Footer 6 Settings', 'basetheme' ),
					'panel'    => 'footer',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-header1'] = array(
					'title'    => __( 'Widget Header Settings', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-header2'] = array(
					'title'    => __( 'Widget Area Settings', 'basetheme' ),
					'panel'    => 'header',
					'priority' => 10,
				);
				$blocks_extra['sidebar-widgets-product-filter'] = array(
					'title'    => __( 'Catalog Off Canvas Sidebar Settings', 'basetheme' ),
					'panel'    => 'woocommerce',
					'priority' => 18,
				);
			...
			if ( class_exists( 'woocommerce' ) ) {
				$extra_woo['woocommerce_product_catalog'] = array(
					'title'    => __( 'Product Catalog', 'basetheme' ),
					'panel'    => 'woocommerce',
					'priority' => 10,
				);
				...
				$extra_woo['product_layout'] = array(
					'title'    => __( 'Single Product Layout', 'basetheme' ),
					'panel'    => 'woocommerce',
					'priority' => 10,
				);
				...
				$extra_woo['account_layout'] = array(
					'title'    => __( 'My Account Layout', 'basetheme' ),
					'panel'    => 'woocommerce',
					'priority' => 24,
				);
				$extra_woo['woocommerce_store_notice_design'] = array(
					'title'    => __( 'Store Notice', 'basetheme' ),
					'panel'    => 'woocommerce',
					'priority' => 10,
				);
				$sections = array_merge(
			...
			if ( class_exists( 'SFWD_LMS' ) ) {
				...
				$extra_learn['sfwd_courses_layout'] = array(
					'title'    => __( 'Course Layout', 'basetheme' ),
					'panel'    => 'learndash',
					'priority' => 10,
				);
				...
				$extra_learn['sfwd_courses_archive_layout'] = array(
					'title'    => __( 'Course Archive Layout', 'basetheme' ),
					'panel'    => 'learndash',
					'priority' => 11,
				);
				...
				$extra_learn['sfwd_lesson_layout'] = array(
					'title'    => __( 'Lesson Layout', 'basetheme' ),
					'panel'    => 'learndash',
					'priority' => 12,
				);
				...
				$extra_learn['sfwd_quiz_layout'] = array(
					'title'    => __( 'Quiz Layout', 'basetheme' ),
					'panel'    => 'learndash',
					'priority' => 12,
				);
				...
				$extra_learn['sfwd_topic_layout'] = array(
					'title'    => __( 'Topic Layout', 'basetheme' ),
					'panel'    => 'learndash',
					'priority' => 12,
				);
				...
				$extra_learn['sfwd_groups_layout'] = array(
					'title'    => __( 'Groups Layout', 'basetheme' ),
					'panel'    => 'learndash',
					'priority' => 11,
				);
				...
				$extra_learn['sfwd_essays_layout'] = array(
					'title'    => __( 'Essay Layout', 'basetheme' ),
					'panel'    => 'learndash',
					'priority' => 11,
				);
				...
				$extra_learn['sfwd_design'] = array(
					'title'    => __( 'Learn Dash Design', 'basetheme' ),
					'panel'    => 'learndash',
					'priority' => 12,
				);
				$extra_learn['sfwd_grid_layout'] = array(
					'title'    => __( 'Course Grid Design', 'basetheme' ),
					'panel'    => 'learndash',
					'priority' => 12,
				);
			...
			if ( class_exists( 'BBPress' ) ) {
				...
				$extra_bbpress['forum_layout'] = array(
					'title'    => __( 'Forum Layout', 'basetheme' ),
					'panel'    => 'bbpress',
					'priority' => 10,
				);
				...
				$extra_bbpress['forum_archive'] = array(
					'title'    => __( 'Forum Archive', 'basetheme' ),
					'panel'    => 'bbpress',
					'priority' => 10,
				);
			...
			if ( class_exists( 'LifterLMS' ) ) {
				...
				$extra_lifter['course_archive'] = array(
					'title'    => __( 'Course Archive', 'basetheme' ),
					'panel'    => 'lifterlms',
					'priority' => 11,
				);
				...
				$extra_lifter['llms_membership_layout'] = array(
					'title'    => __( 'Membership Layout', 'basetheme' ),
					'panel'    => 'lifterlms',
					'priority' => 14,
				);
				$extra_lifter['llms_membership_archive'] = array(
					'title'    => __( 'Membership Archive', 'basetheme' ),
					'panel'    => 'lifterlms',
					'priority' => 15,
				);
				...
				$extra_lifter['llms_dashboard_layout'] = array(
					'title'    => __( 'User Dashboard', 'basetheme' ),
					'panel'    => 'lifterlms',
					'priority' => 16,
				);
				$sections = array_merge(
			...
			if ( defined( 'TRIBE_EVENTS_FILE' ) ) {
				$extra_events['tribe_events_layout'] = array(
					'title'    => __( 'Single Event Layout', 'basetheme' ),
				...
				$extra_events['tribe_events_archive'] = array(
					'title'    => __( 'Events Layout', 'basetheme' ),
					'panel'    => 'tribe_customizer',
					'priority' => 85,
				);
				$sections = array_merge(
			...
			foreach ( $post_types as $post_type_item ) {
				...
				if ( ! in_array( $post_type_name, $ignore_type, true ) ) {
					...
					$extras_post_types[ $post_type_name . '_layout' ] = array(
						'title'    => $post_type_label . ' ' . __( 'Layout', 'basetheme' ),
						'panel'    => 'custom_post',
						'priority' => 10,
					);
					...
					$extras_post_types[ $post_type_name . '_archive' ] = array(
						'title'    => $post_type_label . ' ' . __( 'Archive', 'basetheme' ),
						'panel'    => 'custom_post',
						'priority' => 10,
					);
	...
	public function enqueue_customizer_scripts() {
		...
		wp_enqueue_style( 'thebase-customizer-styles', $path . 'css/thebase-customizer.css', false, basetheme_VERSION );
		if ( is_rtl() ) {
			wp_enqueue_style( 'thebase-customizer-rtl', $path . 'css/rtl-thebase-customizer.css', false, basetheme_VERSION );
		}
		...
		wp_enqueue_script( 'customizer-text-widgets', get_template_directory_uri() . '/assets/js/text-widgets.min.js', array( 'jquery', 'backbone', 'editor', 'wp-util', 'wp-a11y', 'text-widgets' ), basetheme_VERSION, false );
		wp_enqueue_script( 'thebase-customizer-controls', get_template_directory_uri() . '/assets/js/customizer.js', $editor_dependencies, basetheme_VERSION, true );
		wp_enqueue_style( 'thebase-customizer-controls', $path . 'react/build/controls.css', array( 'wp-components' ), basetheme_VERSION );
		wp_localize_script(
	...
	public function action_enqueue_customize_preview_scripts() {
		$path = get_template_directory_uri() . '/inc/customizer/';
		wp_enqueue_style( 'thebase-customizer-preview', $path . 'css/thebase-customizer-preview.css', false, basetheme_VERSION );
		wp_enqueue_script( 'thebase-webfont-js', 'https://ajax.googleapis.com/ajax/libs/webfont/1.6.26/webfont.js', array( 'jquery' ), '1.6.26', true );
		wp_enqueue_script( 'thebase-customizer-preview', $path . 'js/thebase-customizer-preview.min.js', array( 'customize-preview' ), basetheme_VERSION, true );
		wp_localize_script(
