...
class ColorComponent extends Component {
	constructor(props) {
		...
		let defaultParams = {
			...
			colors: {
				palette1: {
					tooltip: __( '1 - Accent', 'basetheme' ),
					palette: false,
				},
				palette2: {
					tooltip: __( '2 - Accent - alt', 'basetheme' ),
					palette: false,
				},
				palette3: {
					tooltip: __( '3 - Strongest text', 'basetheme' ),
					palette: false,
				},
				palette4: {
					tooltip: __( '4 - Strong Text', 'basetheme' ),
					palette: false,
				},
				palette5: {
					tooltip: __( '5 - Medium text', 'basetheme' ),
					palette: false,
				},
				palette6: {
					tooltip: __( '6 - Subtle Text', 'basetheme' ),
					palette: false,
				},
				palette7: {
					tooltip: __( '7 - Subtle Background', 'basetheme' ),
					palette: false,
				},
				palette8: {
					tooltip: __( '8 - Lighter Background', 'basetheme' ),
					palette: false,
				},
				palette9: {
					tooltip: __( '9 - White or offwhite', 'basetheme' ),
					palette: false,
				},
			},
			paletteMap: {
				'palette': {
					'tooltip': __( 'Palette 1', 'basetheme' ),
				},
				'second-palette': {
					'tooltip': __( 'Palette 2', 'basetheme' ),
				},
				'third-palette': {
					'tooltip': __( 'Palette 3', 'basetheme' ),
				}
			}
		};
							...
							<Popover position="bottom right" className="thebase-palette-popover-copy-paste" onClose={ toggleClose }>
								<TabPanel className="thebase-palette-popover-tabs"
									...
									tabs={ [
										{
											name: 'import',
											title: __( 'Select a Color Set', 'basetheme' ),
											className: 'thebase-color-presets',
										},
										{
											name: 'custom',
											title: __( 'Export/Import', 'basetheme' ),
													...
													tabout = (
														<Fragment>
															...
															{ this.state.importError && (
																<p style={{color:'red'}}>{ __( 'Error with Import data', 'basetheme' ) }</p>
															) }
															<Button
