								...
								<Fragment>
									...
									<div className="measure-input-wrap">
										<input
											...
											className="measure-inputs"
										/>
										<small>{ __( 'Right', 'basetheme' ) }</small>
									</div>
									<div className="measure-input-wrap">
										<input
											...
											className="measure-inputs"
										/>
										<small>{ __( 'Bottom', 'basetheme' ) }</small>
									</div>
									<div className="measure-input-wrap">
										<input
