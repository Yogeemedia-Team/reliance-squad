...
$settings = array(
	...
	'info_product_title' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 2,
		'label'        => esc_html__( 'Product Above Content', 'basetheme' ),
		'settings'     => false,
	),
	...
	'product_above_layout' => array(
		...
		'label'        => esc_html__( 'Above Content Layout', 'basetheme' ),
		'transport'    => 'refresh',
		'input_attrs'  => array(
			'layout' => array(
				'title' => array(
					'tooltip' => __( 'Enables an Extra above content title area', 'basetheme' ),
					'name'    => __( 'Extra Title Area', 'basetheme' ),
					'icon'    => '',
				),
				'breadcrumbs' => array(
					'tooltip' => __( 'Enables Breadcrumbs', 'basetheme' ),
					'name'    => __( 'Breadcrumbs', 'basetheme' ),
					'icon'    => '',
				),
				'none' => array(
					'tooltip' => __( 'Hides this area', 'basetheme' ),
					'name'    => __( 'Nothing', 'basetheme' ),
					'icon'    => '',
				),
			),
			'responsive' => false,
	...
	'product_title_align' => array(
		'control_type' => 'thebase_radio_icon_control',
		'section'      => 'product_layout',
		'label'        => esc_html__( 'Product Above Align', 'basetheme' ),
		'priority'     => 4,
	...
	'product_title_height' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 5,
		'label'        => esc_html__( 'Above Container Min Height', 'basetheme' ),
		'context'      => array(
			array(
				'setting'    => 'product_above_layout',
				'operator'   => '=',
	...
	'product_title_elements' => array(
		...
		'label'        => esc_html__( 'Above Elements', 'basetheme' ),
		'transport'    => 'refresh',
		'settings'     => array(
	...
	'product_above_title_font' => array(
		...
		'section'      => 'product_layout_design',
		'label'        => esc_html__( 'Product Above Title Font', 'basetheme' ),
	...
	'product_above_category_font' => array(
		'control_type' => 'thebase_typography_control',
		'section'      => 'product_layout_design',
		'label'        => esc_html__( 'Product Above Category Font', 'basetheme' ),
	...
	'product_title_background' => array(
		...
		'section'      => 'product_layout_design',
		'label'        => esc_html__( 'Product Above Area Background', 'basetheme' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Product Above Title Background', 'basetheme' ),
		),
	),
	...
	'info_product_layout' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 10,
		'label'        => esc_html__( 'Product Layout', 'basetheme' ),
		'settings'     => false,
	),
	...
	'product_single_category_font' => array(
		'control_type' => 'thebase_typography_control',
		'section'      => 'product_layout_design',
		'label'        => esc_html__( 'Product In Content Category Font', 'basetheme' ),
	...
	'product_title_font' => array(
		'control_type' => 'thebase_typography_control',
		'section'      => 'product_layout_design',
		'label'        => esc_html__( 'Product Title Font', 'basetheme' ),
	...
	'product_sidebar_id' => array(
		...
		'section'      => 'product_layout',
		'label'        => esc_html__( 'Product Default Sidebar', 'basetheme' ),
		'transport'    => 'refresh',
		'priority'     => 10,
	...
	'product_content_elements' => array(
		...
		'label'        => esc_html__( 'Product Elements', 'basetheme' ),
		'transport'    => 'refresh',
		'settings'     => array(
	...
	'custom_quantity' => array(
		...
		'label'        => esc_html__( 'Use Custom Quantity Plus and Minus', 'basetheme' ),
		'transport'    => 'refresh',
	),
	'variation_direction' => array(
		...
		'label'        => esc_html__( 'Product Variation Display', 'basetheme' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
				'selector' => 'body.single-product',
		...
		'input_attrs'  => array(
			'layout' => array(
				'horizontal' => array(
					'name' => __( 'Horizontal', 'basetheme' ),
				),
				'vertical' => array(
					'name' => __( 'Vertical', 'basetheme' ),
				),
			),
			'responsive' => false,
		),
	...
	'product_tab_style' => array(
		'control_type' => 'thebase_radio_icon_control',
		'section'      => 'product_layout',
		'label'        => esc_html__( 'Tab Style', 'basetheme' ),
		'priority'     => 10,
	...
	'product_tab_title' => array(
		...
		'label'        => esc_html__( 'Show default headings in tab content', 'basetheme' ),
		'transport'    => 'refresh',
	),
	'product_additional_weight_dimensions' => array(
		...
		'label'        => esc_html__( 'Show Weight and Dimensions in Additional Information tab?', 'basetheme' ),
		'transport'    => 'refresh',
	),
	'product_related' => array(
		...
		'label'        => esc_html__( 'Show Related Products?', 'basetheme' ),
		'transport'    => 'refresh',
	),
	'product_related_columns' => array(
		...
		'section'      => 'product_layout',
		'priority'     => 10,
		'label'        => esc_html__( 'Related Products Columns', 'basetheme' ),
		'transport'    => 'refresh',
	...
	'product_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Product Background', 'basetheme' ),
		),
	),
	'product_content_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Product Content Background', 'basetheme' ),
		),
	),
);
