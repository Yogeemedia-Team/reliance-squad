...
class Component implements Component_Interface {
	...
	public function cart_summary_title() {
		echo '<div class="cart-summary"><h2>' . esc_html__( 'Cart Summary', 'basetheme' ) . '</h2></div>';
	}
	/**
	...
	public function myaccount_nav_avatar() {
		...
		if ( thebase()->option( 'woo_account_navigation_avatar' ) && 0 !== $current_user->ID ) {
			...
			<div class="thebase-account-avatar">
				...
				<a class="tb-link-to-gravatar" href="https://gravatar.com/" target="_blank" rel="no" title="<?php echo esc_attr__( 'Update Profile Photo', 'basetheme' ); ?>">
	...
	public function toggle_list() {
		...
		if ( 1 === wc_get_loop_prop( 'columns' ) ) {
			echo '<div class="thebase-product-toggle-container thebase-product-toggle-outer thebase-single-to-grid">';
				echo '<button title="' . esc_attr__( 'List View', 'basetheme' ) . '" class="thebase-toggle-shop-layout thebase-toggle-list toggle-active" data-archive-toggle="list">';
					thebase()->print_icon( 'list', '', false );
				echo '</button>';
				echo '<button title="' . esc_attr__( 'Grid View', 'basetheme' ) . '" class="thebase-toggle-shop-layout thebase-toggle-grid" data-archive-toggle="grid">';
					thebase()->print_icon( 'grid', '', false );
				echo '</button>';
			echo '</div>';
		} else {
			echo '<div class="thebase-product-toggle-container thebase-product-toggle-outer">';
				echo '<button title="' . esc_attr__( 'Grid View', 'basetheme' ) . '" class="thebase-toggle-shop-layout thebase-toggle-grid toggle-active" data-archive-toggle="grid">';
					thebase()->print_icon( 'grid', '', false );
				echo '</button>';
				echo '<button title="' . esc_attr__( 'List View', 'basetheme' ) . '" class="thebase-toggle-shop-layout thebase-toggle-list" data-archive-toggle="list">';
					thebase()->print_icon( 'list', '', false );
				echo '</button>';
			echo '</div>';
		}
