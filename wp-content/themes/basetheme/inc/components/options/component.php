		...
		if ( is_null( self::$default_options ) ) {
			self::$default_options = apply_filters(
				...
				array(
					...
					// Header HTML.
					'header_html_content'    => __( 'Insert HTML here', 'basetheme' ),
					...
					// Header Button.
					'header_button_label'      => __( 'Button', 'basetheme' ),
					'header_button_link'      => '',
					...
					'mobile_button_label'      => __( 'Button', 'basetheme' ),
					...
					// Mobile Header HTML.
					'mobile_html_content'    => __( 'Insert HTML here', 'basetheme' ),
