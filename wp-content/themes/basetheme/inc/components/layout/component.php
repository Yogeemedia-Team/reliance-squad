...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		$widgets = array(
			'sidebar-primary'   => __( 'Sidebar 1', 'basetheme' ),
			'sidebar-secondary' => __( 'Sidebar 2', 'basetheme' ),
			'footer1'           => __( 'Footer 1', 'basetheme' ),
			'footer2'           => __( 'Footer 2', 'basetheme' ),
			'footer3'           => __( 'Footer 3', 'basetheme' ),
			'footer4'           => __( 'Footer 4', 'basetheme' ),
			'footer5'           => __( 'Footer 5', 'basetheme' ),
			'footer6'           => __( 'Footer 6', 'basetheme' ),
		);
