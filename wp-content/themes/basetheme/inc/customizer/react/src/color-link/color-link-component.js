	...
	constructor(props) {
		...
		let defaultParams = {
			colors: {
				...
				'highlight-alt2': {
					tooltip: __( 'Text Alt', 'basetheme' ),
					palette: true,
				},
			},
			styles: {
				'standard': {
					label: __( 'Standard (underline)', 'basetheme' ),
				},
				'color-underline': {
					label: __( 'Highlight Underline', 'basetheme' ),
				},
				'no-underline': {
					label: __( 'No Underline', 'basetheme' ),
				},
				'hover-background': {
					label: __( 'Background on Hover', 'basetheme' ),
				},
				'offset-background': {
					label: __( 'Offset Background', 'basetheme' ),
				},
			},
		};
