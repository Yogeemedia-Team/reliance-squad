...
class BackgroundComponent extends Component {
	constructor(props) {
		...
		let defaultParams = {
			...
			repeat: {
				'no-repeat': {
					name: __( 'No Repeat', 'basetheme' ),
				},
				'repeat': {
					name: __( 'Repeat', 'basetheme' ),
				},
				'repeat-x': {
					name: __( 'Repeat-X', 'basetheme' ),
				},
				'repeat-y': {
					name: __( 'Repeat-y', 'basetheme' ),
				},
			},
			size: {
				auto: {
					name: __( 'Auto', 'basetheme' ),
				},
				cover: {
					name: __( 'Cover', 'basetheme' ),
				},
				contain: {
					name: __( 'Contain', 'basetheme' ),
				},
			},
			attachment: {
				scroll: {
					name: __( 'Scroll', 'basetheme' ),
				},
				fixed: {
					name: __( 'Fixed', 'basetheme' ),
				},
			},
			attachments: {
				desktop: {},
	...
	render() {
		...
		const controlLabel = (
			<Fragment>
				{ this.state.currentDevice !== 'desktop' && (
					<Tooltip text={ __( 'Reset Device Values', 'basetheme' ) }>
						<Button
		...
		if( this.state.supportGradient ) {
			tab_options = [
				{
					name: 'color',
					title: __( 'Color', 'basetheme' ),
					className: 'thebase-color-background',
				},
				{
					name: 'gradient',
					title: __( 'Gradient', 'basetheme' ),
			...
			<div className="thebase-control-field thebase-background-control">
				...
				>
					<div className="thebase-background-picker-wrap">
												...
												if ( 'image' === tab.name ) {
													tabout = (
														<Fragment>
															...
															<span className="customize-control-title">{ __( 'Background Repeat', 'basetheme' ) }</span>
															...
															<span className="customize-control-title">{ __( 'Background Size', 'basetheme' ) }</span>
															<ButtonGroup className="thebase-radio-container-control">
															...
															<span className="customize-control-title">{ __( 'Background Attachment', 'basetheme' ) }</span>
															<ButtonGroup className="thebase-radio-container-control">
						...
						<Tooltip text={ this.controlParams.tooltip ? this.controlParams.tooltip : __( 'Select Background', 'basetheme' ) }>
