...
class RadioIconComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			include: {
				logo_only: {
					tooltip: __( 'Logo Only', 'basetheme' ),
					name: __( 'Logo', 'basetheme' ),
				},
				logo_title: {
					tooltip: __( 'Logo & Title', 'basetheme' ),
					name: __( 'Logo & Title', 'basetheme' ),
				},
				logo_title_tagline: {
					tooltip: __( 'Logo, Title & Tagline', 'basetheme' ),
					name: __( 'Logo, Title & Tagline', 'basetheme' ),
				},
			},
			layout: {
				logo_only: {
				...
				logo_title: {
					...
					title_logo: {
						tooltip: __( 'Title - Logo', 'basetheme' ),
						icon: Icons.titleLogo
					},
					top_logo_title: {
						tooltip: __( 'Top Logo - Title', 'basetheme' ),
						icon: Icons.topLogoTitle
					},
					top_title_logo: {
						tooltip: __( 'Top Title - Logo', 'basetheme' ),
				...
				logo_title_tagline: {
					...
					title_tag_logo: {
						tooltip: __( 'Title - Tagline - Logo', 'basetheme' ),
						icon: Icons.titleTagLogo
					},
					top_logo_title_tag: {
						tooltip: __( 'Top Logo - Title - Tagline', 'basetheme' ),
						icon: Icons.topLogoTitleTag
					},
					top_title_tag_logo: {
						tooltip: __( 'Top Title - Tagline - Logo', 'basetheme' ),
						icon: Icons.topTitleTagLogo
					},
					top_title_logo_tag: {
						tooltip: __( 'Top Title - Logo - Tagline', 'basetheme' ),
