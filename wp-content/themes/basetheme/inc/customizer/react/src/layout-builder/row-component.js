		...
		return (
			<div className={ `thebase-builder-areas ${ centerClass }` }>
				<Button
					...
					aria-label={ __( 'Edit Settings for', 'basetheme' ) + ' ' + ( this.props.row === 'popup' ? __( 'Off Canvas', 'basetheme' ) : this.props.row + ' ' + __( 'Row', 'basetheme' ) ) }
				...
				<Button
					...
					onClick={ () => this.props.focusPanel( mode + '_' + this.props.row ) }
				>
					{ ( this.props.row === 'popup' ? __( 'Off Canvas', 'basetheme' ) : this.props.row + ' ' + __( 'Row', 'basetheme' ) ) }
