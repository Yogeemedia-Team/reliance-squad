...
Theme_Customizer::add_settings(
	array(
		...
		'header_cart_label' => array(
			...
			'label'        => esc_html__( 'Cart Label', 'basetheme' ),
			'live_method'     => array(
				array(
					'type'     => 'html',
		...
		'header_cart_icon' => array(
			...
			'label'        => esc_html__( 'Cart Icon', 'basetheme' ),
			'partial'      => array(
		...
		'header_cart_style' => array(
			...
			'label'        => esc_html__( 'Cart Click Action', 'basetheme' ),
			'transport'    => 'refresh',
			'input_attrs'  => array(
				'layout' => array(
					'link' => array(
					...
					'slide' => array(
						'name' => __( 'Popout Cart', 'basetheme' ),
					),
					'dropdown' => array(
						'name' => __( 'Dropdown Cart', 'basetheme' ),
					),
				),
				'responsive' => false,
			),
		...
		'header_cart_show_total' => array(
			...
			'label'        => esc_html__( 'Show Item Total Indicator', 'basetheme' ),
		),
		...
		'header_cart_background' => array(
			'control_type' => 'thebase_color_control',
			'section'      => 'cart_design',
			'label'        => esc_html__( 'Cart Background', 'basetheme' ),
		...
		'header_cart_total_background' => array(
			'control_type' => 'thebase_color_control',
			'section'      => 'cart_design',
			'label'        => esc_html__( 'Cart Total Background', 'basetheme' ),
		...
		'header_cart_typography' => array(
			...
			'section'      => 'cart_design',
			'label'        => esc_html__( 'Cart Label Font', 'basetheme' ),
			'context'      => array(
				array(
		...
		'header_cart_padding' => array(
			...
			'label'        => esc_html__( 'Cart Padding', 'basetheme' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '.site-header-item .header-cart-wrap .header-cart-inner-wrap .header-cart-button',
