...
Theme_Customizer::add_settings(
	array(
		...
		'sidebar_width' => array(
			...
			'section'      => 'sidebar',
			'priority'     => 10,
			'label'        => esc_html__( 'Sidebar Width', 'basetheme' ),
			// 'context'      => array(
			// 	array(
		...
		'sidebar_background' => array(
			...
			'section'      => 'sidebar_design',
			'label'        => esc_html__( 'Sidebar Background', 'basetheme' ),
			...
			'input_attrs'  => array(
				'tooltip'  => __( 'Sidebar Background', 'basetheme' ),
			),
		),
		'sidebar_divider_border' => array(
			'control_type' => 'thebase_border_control',
			'section'      => 'sidebar_design',
			'label'        => esc_html__( 'Sidebar Divider Border', 'basetheme' ),
		...
		'sidebar_padding' => array(
			...
			'label'        => esc_html__( 'Sidebar Padding', 'basetheme' ),
			// 'context'      => array(
			// 	array(
			// 		'setting' => '__current_tab',
			// 		'value'   => 'design',
		...
		'sidebar_sticky' => array(
			...
			'label'        => esc_html__( 'Enable Sticky Sidebar', 'basetheme' ),
			'transport'    => 'refresh',
		),
		'sidebar_sticky_last_widget' => array(
			...
			'label'        => esc_html__( 'Only Stick Last Widget', 'basetheme' ),
			'transport'    => 'refresh',
			'context'      => array(
				array(
