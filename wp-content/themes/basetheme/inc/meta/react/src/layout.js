...
class TheBaseThemeLayout extends Component {
	...
	render() {
		...
		const titleOptions = {
			'default': {
				tooltip: __( 'Inherited Default', 'basetheme' ),
				icon: 'inherit',
			},
			'hide': {
				tooltip: __( 'Hide Title', 'basetheme' ),
				icon: 'hidetitle',
			},
			'normal': {
				tooltip: __( 'Show In Content', 'basetheme' ),
				icon: 'incontent',
			},
			'above': {
				tooltip : __( 'Show Above Content', 'basetheme' ),
				icon: 'abovecontent',
			},
		}
		...
		return (
			<Fragment>
				<PluginSidebarMoreMenuItem
					...
					icon={ icon }
				>
					{ thebaseMetaParams.post_type_name + ' ' + __( 'Settings', 'basetheme' ) }
				</PluginSidebarMoreMenuItem>
				<PluginSidebar
					isPinnable={ true }
					icon={ icon }
					name="theme-meta-panel"
					title={ thebaseMetaParams.post_type_name + ' ' + __( 'Settings', 'basetheme' ) }
				>
